...
class RecalculateTagStats extends AbstractCommand
{
    ...
    {
        $this
            ->setName('recalculate_stats:tags')
            ->setDescription('Recalculate stats and last posted discussion for all tags/categories.');
    }
    ...
    protected function fire()
    {
        ...
        $query = file_get_contents(dirname(__FILE__, 3).'/sql/update_tag_stats.sql');
